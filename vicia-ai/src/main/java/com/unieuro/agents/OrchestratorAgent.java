...
public class OrchestratorAgent {
    ...
    void run(IInternalAccess agent) {
        ...
        for(String url : gameUrls) {
            ...
            // Adiciona as listas de reviews brutas que vêm do adapter_scrape_details.py
            consolidatedData.put("positive_reviews", gameDetails.getOrDefault("reviews_positive", new ArrayList<>()));
            consolidatedData.put("mixed_reviews", gameDetails.getOrDefault("reviews_mixed", new ArrayList<>()));
            consolidatedData.put("negative_reviews", gameDetails.getOrDefault("reviews_negative", new ArrayList<>()));
            // --- FIM DA CORREÇÃO ---
